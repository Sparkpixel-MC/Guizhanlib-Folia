...
public final class NewBlockStorageUtil {
    ...
    @ParametersAreNonnullByDefault
    public static void executeAfterLoad(SlimefunBlockData data, Runnable runnable, SchedulerContext context) {
        StorageCacheUtils.executeAfterLoad(data, runnable, context);
    }

    @ParametersAreNonnullByDefault
    public static void executeAfterLoad(Location l, Runnable runnable) {
        SlimefunBlockData data = getBlock(l);
        if (data == null) {
            return;
        }
        SchedulerContext context = SchedulerContext.of(l);
        executeAfterLoad(data, runnable, context);
    }

    @ParametersAreNonnullByDefault
    public static void executeAfterLoad(Block b, Runnable runnable) {
        executeAfterLoad(b.getLocation(), runnable);
    }
}
